...
export_path = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404/src/train/240407/grid_search_240407.csv"
            ...
            for encoder_filters in [[16, 32, 64], [16, 32, 64, 128]]:
                ...
                for num_group_norm in [4, 8, 16]:
                    ...
                    for attention_type in [1]:
                        ...
                        for image_preprocess_normalization in ['min_max_local', 'min_max_global']:
                            
                            for num_conv in [1, 2]:
                            
                                for class_weight in [[1., 1.], [1., 2.]]:
