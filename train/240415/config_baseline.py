...
class Config():
    ...
    def __init__(self,
        ...
        #########################################################################
        #                            TRAINING DETAIL
        self.EXPORT_PATH = "/home/efs/ziping/workspaces/dfu/clf_algo_release_202404/results/240415/" + self.MODEL.strip().lower()
...
if __name__ == "__main__":
    ...
    gs_df = pd.read_csv("grid_search_240415.csv")
    ...
    image_preprocess = {
        ...
        'INCLUDE_EU': gs_df.iloc[idx]['include_EU'],
